    ...
    <section id="how-it-works" className="bg-white dark:bg-slate-950 transition-colors duration-300">
      <Container>
        <div className="text-center max-w-3xl mx-auto mb-16">
          <h2 className="text-3xl md:text-4xl font-bold mb-6 text-brand-heading dark:text-white tracking-tight transition-colors duration-300">How It Works</h2>
          <p className="text-lg text-brand-text/80 dark:text-slate-300 leading-relaxed transition-colors duration-300">
            WellFlow is the workflow engine at the center of AridInsights. It reduces manual research,
            standardizes information, and makes groundwater compliance more predictable.
          </p>
        </div>
