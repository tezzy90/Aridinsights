      ...
      <Container>
        <div className="max-w-3xl mb-12 md:mb-16">
          ...
          <p className="text-lg text-brand-text/90 dark:text-slate-300 leading-relaxed transition-colors duration-300">
            Texas is our validation market for water intelligence infrastructure. With 98+ Groundwater Conservation Districts,
            it presents one of the clearest regulatory fragmentation challenges in the country.
            Solving this problem cleanly demonstrates our repeatable approach to other fragmented water markets.
          </p>
        </div>
