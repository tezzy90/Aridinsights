...
exports.handleContextPack = handleContextPack;
 ...
 */
async function handleContextPack(db, jobId, orderId) {
    ...
    const inputs = (orderData === null || orderData === void 0 ? void 0 : orderData.inputs) || {};
    const { metro } = inputs;
    ...
    const productType = orderData === null || orderData === void 0 ? void 0 : orderData.productType;
    let nextJobType = "SCORECARD_GEN";
    if (productType === "AUDIT")
        nextJobType = "AUDIT_GEN";
