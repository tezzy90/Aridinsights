...
exports.onJobCreated = exports.createOrder = void 0;
const https_1 = require("firebase-functions/v2/https");
const logger = require("firebase-functions/logger");
const firestore_1 = require("firebase-admin/firestore");
const customerUtils_1 = require("./utils/customerUtils");
...
exports.createOrder = (0, https_1.onRequest)(async (req, res) => {
    try {
        ...
        // Upsert Customer
        const customerId = await (0, customerUtils_1.upsertCustomer)(email, {
        ...
        const missingFields = [];
        if (!inputs.metro)
            missingFields.push("metro");
        if (!inputs.it_load_mw_current || inputs.it_load_mw_current <= 0)
            missingFields.push("it_load_mw_current");
        ...
        await firebase_1.db.collection("jobs").doc(jobId).set({
            orderId,
...
Object.defineProperty(exports, "onJobCreated", { enumerable: true, get: function () { return jobRunner_1.onJobCreated; } });
